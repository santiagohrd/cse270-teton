...
class TestSmokeTest():
  ...
  def test_commonpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html/teton/1.6/index.html")
    self.driver.set_window_size(1854, 1048)
  ...
  def test_homepage(self):
    ...
    assert len(elements) > 0
    element = self.driver.find_element(By.LINK_TEXT, "Join Us")
  ...
  def test_joinpage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Herrera")
